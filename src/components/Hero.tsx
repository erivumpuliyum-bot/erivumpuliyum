  ...
  return (
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center px-4">
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          >
            <button
              ...
              className="group flex items-center justify-center gap-3 px-8 py-4 bg-green-700 hover:bg-green-800 text-white rounded-full font-semibold text-lg transition-all duration-300 shadow-xl hover:shadow-2xl hover:-translate-y-1 hover-glow"
            ...
            <button
              ...
              className="group flex items-center justify-center gap-3 px-8 py-4 bg-white/15 backdrop-blur-sm border-2 border-white/50 text-white rounded-full font-semibold text-lg hover:bg-white/25 transition-all duration-300 hover:-translate-y-1"
              style={{ fontFamily: "'Poppins', sans-serif" }}
            >
          ...
          {/* Info Bar */}
          <div 
            className={`flex flex-wrap items-center justify-center gap-4 md:gap-6 mb-8 transition-all duration-1000 ${
              isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
            }`}
        ...
        <div 
          className={`absolute bottom-8 left-1/2 transform -translate-x-1/2 text-center transition-all duration-1000 ${
        ...
        >
          ...
          >
            <div className="w-7 h-12 border-2 border-white/40 rounded-full flex justify-center pt-2 hover:border-white/60 transition-colors">
